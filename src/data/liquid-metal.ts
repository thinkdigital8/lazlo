...
export const finishes = [
  {
    ...
    name: "Lite Brass",
    swatch: "#c8be92",
    description: "A pale, softly mottled brass tone with a warm champagne glow.",
  },
  {
    slug: "dark-brass",
    name: "Dark Brass",
    swatch: "#9c7f34",
    description: "A deeper, antiqued brass with rich golden-umber undertones.",
  },
  {
    slug: "copper",
    name: "Copper",
  ...
  },
  {
    ...
    name: "Tin",
    swatch: "#a7acb2",
    description: "A cool, brushed silver-grey finish with a quiet industrial character.",
  },
  {
    slug: "brass",
    name: "Brass",
  ...
  },
  {
    ...
    name: "Dark Bronze",
    swatch: "#4a3d2e",
    description: "A deep, near-black bronze with a dense, architectural weight.",
  },
  {
    slug: "iron",
    name: "Iron",
  ...
  },
  {
    ...
    name: "Bronze",
    swatch: "#d29a7d",
    description: "A warm, sunlit bronze with soft rose-gold undertones.",
  },
  {
    slug: "dark-copper",
    name: "Dark Copper",
    swatch: "#6b352c",
    description: "A deep, oxidised copper with wine-red undertones.",
  },
  {
    slug: "rust",
    name: "Rust",
    swatch: "#b6602a",
    description:
      "A weathered, oxidised texture with deep burnt-orange and umber variation — handcrafted so every sheet is unique.",
  },
  {
    slug: "verdigris",
    name: "Verdigris",
    swatch: "#4c9d93",
    description: "A blue-green oxidised finish reminiscent of aged monuments and heritage architecture.",
  },
  {
    slug: "black-antique-patina",
    name: "Black Antique Patina",
    swatch: "#33321f",
    description: "A darkened, antiqued metal finish with a subtly aged, shadowed character.",
  },
] as const;
